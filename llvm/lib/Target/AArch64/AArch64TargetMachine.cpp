...
void AArch64PassConfig::addIRPasses() {
  ...
  addPass(PARTS::createPartsOptBuiltinsPass());
  ...
  //const auto AOSHeapInst = AOS::getAOSHeapInstType();

  //addPass(createAOSGlobalVariableOptPass()); //yh+
...
void AArch64PassConfig::addPostRegAlloc() {
  ...
  if (PARTS::useDpi()) {
    ...
    //yh-addPass(createAArch64PartsDpiForCSR());
...
void AArch64PassConfig::addPreEmitPass() {
  ...
  //if (AOSHeapInst == AOS::AOSHeapInstEnabled)
    addPass(createAArch64AOSPass()); //yh+
  ...
  if (PARTS::useAny()) {
    ...
    if (PARTS::useRuntimeStats())
      addPass(createAArch64PartsPassRuntimeStatistics());
